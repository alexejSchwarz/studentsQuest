...
public class CreditScreen implements Screen, ScreenKeyInputListener {
    ...
    public CreditScreen(StudentsQuest context) {
    ...
    private void createUI() {
        this.background = new Image(this.context.getAssetManager().get(AssetPaths.CREDIT_SCREEN.getPath(), Texture.class));
        ...
        this.backToMainMenuButton.setPosition(12f, 0.2f);
